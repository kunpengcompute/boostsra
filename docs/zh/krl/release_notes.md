...
<td class="cellrowborder" valign="top" width="84.93%" headers="mcps1.1.3.1.2 "><p id="p515310015517"><a name="p515310015517"></a><a name="p515310015517"></a>新增基于鲲鹏平台优化的用于加速向量检索的算子库KRL（Kunpeng Retrieval Library，鲲鹏检索算子库）。</p>
</td>
</tr>
</tbody>
</table>
...
<thead align="left">
<tr id="row28804032">
<th class="cellrowborder" valign="top" width="42.72%" id="mcps1.1.4.1.1"><p id="p4697041">文档名称</p></th>
<th class="cellrowborder" valign="top" width="40.32%" id="mcps1.1.4.1.2"><p id="p44916036">内容简介</p></th>
<th class="cellrowborder" valign="top" width="16.96%" id="mcps1.1.4.1.3"><p id="p14320308">交付形式</p></th>
</tr>
</thead>
<tbody>
<tr id="row19094280">
