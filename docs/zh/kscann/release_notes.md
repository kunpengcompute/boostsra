...
新增基于鲲鹏架构深度优化索引布局和算法流程，鲲鹏亲和的自研算法体系KScaNN（Kunpeng Scalable Nearest Neighbors）。
...
<thead align="left">
<tr id="row28804032">
<th class="cellrowborder" valign="top" width="40.510000000000005%" id="mcps1.1.4.1.1"><p id="p4697041">文档名称</p></th>
<th class="cellrowborder" valign="top" width="42.53%" id="mcps1.1.4.1.2"><p id="p44916036">内容简介</p></th>
